...
<div class="wrapper">
    <?php include '../../view/admin/layout/category.php' ?>
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                    <img class="avatar border-gray" src="../../view/admin/assets/img/faces/avatar.jpg" alt="..."/>

                                      <h4 class="title">Lương Công Chương<br />
                                         <small>congchuong</small>
                                      </h4>
                                    </a>
                                </div>
