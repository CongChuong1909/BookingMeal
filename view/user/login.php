            ...
            <div class="grid form">
                ...
                <form id="login_form" class="form_class" action="./Login.php" method="post">
                    ...
                    <div class="form_div">
                        ...
                        <input class="field_class" name="txt_username" type="text" placeholder="Enter your login name..." autofocus>
                        <label>Password:</label>
                        <input id="pass" class="field_class" name="txt_password" type="password" placeholder="Enter your password">
                        <input class="submit_class" type = "submit" name ="userActtion" value="login" form="login_form"></input>
                    </div>
                    <div class="info_div">
